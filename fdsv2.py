...
def bolgekontrol():
    ...
    orjinbolgefile = open("orjnbolge.txt", "r")
    ...
    if not '@turksat.com.tr' in orjinbolgefilelist:
        ...
        with open('orjnbolge.txt', 'w', encoding="utf-8") as f:
            f.write(orjinbolge)
            print('Dosyaya Kaydedildi.')
...
def sistemegiris():
    ...
    try:
        import webbrowser
        print('##################################################################################')
        print("Macbook için Mail Uygulamasını Açıyorum...")
        ...
        if '1' in bolgesecimlist:
            ...
            webbrowser.open("mailto:"+mailTo+'?cc='+mailCC+'&subject='+mailSubject+'&body='+mailHtmlBody, new=1)
        ...
        with open('mailmanuel.txt', 'w', encoding="utf-8") as f:
            f.write(mailtext)
            print('##################################################################################')
            print('Dosya mailmanuel.txt adıyla kaydedildi.')
        webbrowser.open('mailmanuel.txt')
